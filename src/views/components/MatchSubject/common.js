...
export class Subject {
  constructor ({ent_id, acct_catalog, acct_code, acct_name, is_matched, is_auto, dest_acct_code, dest_acct_name, acct_val, acct_list}) {
    this.ent_id = ent_id
...
export class ParamObj {
  constructor ({ent_id, acct_catalog, acct_code, acct_name, acct_val, is_matched, is_auto}){
    this.ent_id = ent_id
    this.acct_catalog = acct_catalog
    this.acct_code = acct_code
    this.acct_name = acct_name
    this.dest_acct_code = acct_val
    this.dest_acct_name = acct_val
...
export function createParamObj (rowData) {
  return new ParamObj({
    ...
    dest_acct_code: rowData.acct_val ? rowData.acct_val.split(' ')[0] : '',
    dest_acct_name: rowData.acct_val ? rowData.acct_val.split(' ')[1] : '',
    is_matched: rowData.is_matched,
